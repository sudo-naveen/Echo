      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1">
              <li><Link to="/support" className="text-sm text-gray-500 hover:text-primary-600 transition">Help & Support</Link></li>
              <li><a href="mailto:johnysins09134@gmail.com" className="text-sm text-gray-500 hover:text-primary-600 transition">Email Us</a></li>
