...
async function seed() {
  ...
  const answersData = [
    ...
    // Answers for Microsoft questions
    ...
    { content: 'Structure your answer in 3 parts: (1) Present - briefly describe your current role and key responsibilities. (2) Past - highlight 2-3 relevant experiences or achievements from previous roles. (3) Future - explain why you are interested in this role and how your skills align. Keep it to 60-90 seconds. Practice but sound natural.', question_id: 45, user_id: 2 },
    { content: 'Choose genuine weaknesses that are not core to the job. Show self-awareness and describe specific steps you are taking to improve. For strengths, pick relevant skills and back them with concrete examples. Avoid cliché weaknesses like "I work too hard" or "I am a perfectionist."', question_id: 46, user_id: 3 },
    { content: 'Systematic debugging process: (1) Reproduce the issue consistently. (2) Check recent changes and logs. (3) Isolate the problem by eliminating variables. (4) Use debuggers, profilers, or tracing tools. (5) Write a failing test that reproduces the issue. (6) Identify root cause. (7) Implement fix. (8) Verify fix and add regression tests.', question_id: 49, user_id: 4 },
  ];
